...
import org.cloudsimplus.heuristics.VmToHostMappingHeuristic;
import org.cloudsimplus.heuristics.VmToHostMappingSolution;
 ...
 */
public class DatacenterBrokerHeuristicVmToHost extends DatacenterBrokerSimple {
    /**
     * @see #getHeuristic()
     */
    private VmToHostMappingHeuristic heuristic;

    /**
     * Creates a new DatacenterBroker object.
     *
     * @param simulation The CloudSim instance that represents the simulation the Entity is related to
     * @see #setHeuristic(VmToHostMappingHeuristic)
     */
    public DatacenterBrokerHeuristicVmToHost(final CloudSim simulation) {
        super(simulation);
        heuristic = VmToHostMappingHeuristic.NULL;
    }

    // find suitable replacement for below
    //    @Override
...
//    }
    ...
    /**
     * Sets up the heuristic parameters and starts the heuristic to find a suboptimal mapping for Cloudlets and Vm's.
     */
    private void setupAndStartHeuristic() {
        heuristic.setVmList(getVmExecList());
        // find replacement for below
        ...
        for the Vms to Hosts mapping.
        Depending on the heuristic parameters, it may take a while
        to get a solution.
        */
        LOGGER.info(
            "{} started the heuristic to get a suboptimal solution for mapping Vms to Hosts running {} neighborhood searches by iteration.{}{}",
            this, heuristic.getNeighborhoodSearchesByIteration(),
            System.lineSeparator(),
            "Please wait... It may take a while, depending on heuristic parameters and number of Vms and Hosts.");

        final VmToHostMappingSolution solution = heuristic.solve();
        LOGGER.info(
            "{} finished the solution find for mapping Vms to Hosts in {} seconds with a solution cost of {}",
...
//    }
     ...
     * Cloudlets and Vm's
     */
    public Heuristic<VmToHostMappingSolution> getHeuristic() {
        return heuristic;
    }

    /**
     * <p>Sets a heuristic to be used to find a sub-optimal mapping between
     * Vms and Hosts. <b>The list of Vms and Hosts to be used by the heuristic
     ...
     *
     * <p>The time taken to find a suboptimal mapping of Vms to Hosts
     ...
     */
    public DatacenterBrokerHeuristicVmToHost setHeuristic(final VmToHostMappingHeuristic heuristic) {
